...
export const HERO_CONTENT = `A Passionate software developer exploring the fields of Artificial Intelligence (AI), Machine Learning (ML), and full-stack development. As an AI Student, My main focus is on training advanced AI models, optimizing Artificial Neural Networks (ANNs), and implementing Natural Language Processing (NLP) techniques. I am also deepening my understanding of Computer Vision (CV) to develop AI-driven solutions for real-world applications.`
export const HERO_CONTENT_2 = `Alongside AI, I am gaining hands-on experience in web development using the MERN stack (MongoDB, Express, React, Node.js) to create dynamic, responsive, and scalable web applications. I also have experience solving complex problems with data structures, algorithms, and databases like MySQL, continuously striving to write efficient and optimized code.`
