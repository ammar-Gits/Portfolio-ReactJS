  ...
  return (
    <div className='border-neutral-900 lg:mb-35 px-4 md:px-0'>
      <div className='flex flex-wrap'>
        <div className='w-full lg:w-1/2'>
          <div className='py-10 md:py-20 flex flex-col items-center lg:items-start'>
            <motion.h1
              ...
              whileInView="visible"
              viewport={{ once: false }}
              className='pb-6 md:pb-16 text-4xl md:text-6xl font-thin tracking-tight text-center lg:text-left lg:mt-16 lg:text-7xl'
            >
              Muhammad Ammar
            </motion.h1>
            <motion.span
        ...
        <div className='w-full lg:w-1/2 lg:p-35'>
